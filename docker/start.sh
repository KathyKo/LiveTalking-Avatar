...
export DITTO_START_BUFFER=${DITTO_START_BUFFER:-3}
export DITTO_HOLD=${DITTO_HOLD:-0.30}
export DITTO_TAIL_MS=${DITTO_TAIL_MS:-520}
export DITTO_IDLE_FADE_MS=${DITTO_IDLE_FADE_MS:-120}
export DITTO_AV_OFFSET_MS=${DITTO_AV_OFFSET_MS:-0}
export DITTO_STOP_DRAIN_S=${DITTO_STOP_DRAIN_S:-1.5}
