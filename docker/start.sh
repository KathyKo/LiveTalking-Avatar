...
export DITTO_START_BUFFER=${DITTO_START_BUFFER:-8}
export DITTO_TAIL_MS=${DITTO_TAIL_MS:-300}
export DITTO_AV_OFFSET_MS=${DITTO_AV_OFFSET_MS:-100}
export DITTO_VAD=${DITTO_VAD:-1}
export DITTO_VAD_RMS=${DITTO_VAD_RMS:-0.006}
export DITTO_VAD_MIN_MS=${DITTO_VAD_MIN_MS:-80}
